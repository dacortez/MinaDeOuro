 ...
 * ser implementado pelasinstâncias concreta do agente que deriva desta 
...
public abstract class Agent {
	...
	/**
	 * @return O objeto Solution correspondente a melhor solução encontrada 
	 * pelo agente de acordo com a sua estratégia de busca, considerando um
	 * valor único de pepitas a serem coletadas armazenado na variável 
	 * goldGoal.
	 */
	 ...
	 * em que o agente retorna à sua posição inicial após ter coletado o número correto
