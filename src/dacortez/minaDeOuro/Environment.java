 ...
 * ao agente decidir como se mover ou se é possível pegar ouro. 
 * 
 * @author dacortez
 * @version 2013.09.26
 */
public class Environment {
	...
	/**
	 * Atribui o conteúdo content na posição position da mina.
	 * @param position A posição da mina onde se deseja atribuir o conteúdo.
	 ...
	 * @return O custo associado a ação action.
	 */
